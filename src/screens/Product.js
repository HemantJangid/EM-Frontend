        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-5">
              <h2>
                Comfortable<span className="pri">.</span> Safe
                <span className="pri">.</span> Sturdy
                <span className="pri">.</span>
              </h2>
              <p>
                T-REX promises comfort and safety to the riders. The saddle is
                made of high-quality Hydrodyne Foam-Soft PU MTB to provide
                comfortable seating. The Hardtail Alloy Hydroformed type frame
                with rear hub motor adds to the power of this piece of
                thoughtfully designed e-bike.
              </p>
              <table>
                <tr>
