...
function Insurance() {
    return <div>
        ...
        <section id="insurance">
            <div className="container">
                <p>Here’s how to go about getting your EMI approved from EMs EMI Partner: On the Emotorad cart page, you can select EMs EMI Partner at the checkout and set up your EMs EMI Partner account in a couple of minutes. All you need is your AADHAR CARD/PAN number and details of your bank account (to make repayments). After providing some basic information, you will be given instant approval and then be asked to make a small upfront payment. At this point your transaction is confirmed. Before your shopping can be dispatched, EMs EMI Partner will ask for bank statements and a proof of ID.</p>
                <p>Uploading your documents couldn’t be easier but they can also send an agent to your house or office.</p>
                <p>EMs EMI Partner charges a simple processing fee and an affordable interest rate — depending on the product you are purchasing.</p>
